# Aligning the images: you can align the image by using float , it can be left or right . you can align the image in the center of the page by give it a class name and in Css display:block;margin: opx auto;
